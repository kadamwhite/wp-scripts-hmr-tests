...
/**
 * Unregister a block that's being hot-swapped, so that the updated version can
 * be registered afresh without error.
 *
 ...
 * The active block will be reselected in the refreshHotBlock function.
 *
 * @param {string} hotBlockName Name of block being hot-reloaded.
 */
export const deregisterHotBlock = ( hotBlockName ) => ( data ) => {
 ...
 */
export const refreshHotBlock = ( hotBlockName, data ) => {
